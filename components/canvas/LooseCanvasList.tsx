...
import { deleteCanvas, getLooseCanvasForUser, updateCanvasName } from '@/lib/actions/canvas';
          ...
          return (
            <li key={canvas.id} className='flex justify-between items-center px-6 py-4 mb-4 border border-base-300 rounded-lg shadow-sm'>
              ...
              <div className='flex gap-6 items-center'>
                ...
                <Link href={`canvas/${canvas.id}`} className='btn btn-accent btn-xs' >
                  edit
                </Link>
...
export default LooseCanvasList